...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/mattmonroe/jacobson)  
...
* **务必替换所有的b6a643d2-f7b5-4e53-b899-26d862c814f1为部署时设置的AUUID**  
...
* 端口：443
* 默认UUID：b6a643d2-f7b5-4e53-b899-26d862c814f1
* 加密：none
* 传输协议：ws
* 伪装类型：none
* 路径：/b6a643d2-f7b5-4e53-b899-26d862c814f1-vless // 默认vless使用/$uuid-vless，vmess使用/$uuid-vmess
* 底层传输安全：tls
```
</details>
...
* 客户端下载: https://github.com/p4gefau1t/trojan-go/releases
{
    ...
    "remote_port": 443,
    "password": [
        "b6a643d2-f7b5-4e53-b899-26d862c814f1"
    ],
    "websocket": {
        "enabled": true,
        "path": "/b6a643d2-f7b5-4e53-b899-26d862c814f1-trojan",
...
* 插件选项: tls;host=appname.herokuapp.com;path=/b6a643d2-f7b5-4e53-b899-26d862c814f1-ss
```
</details>
